...
import 'package:bastion23/Screens/qr_scanner_screen.dart';
import 'package:bastion23/Screens/video_screen.dart';
...
class ImageScreenState extends State<ImageScreen> {
  ...
  void CapturePicture() async {
    ...
    try {
      ...
      audioPlayer.open(Audio('assets/audios/cameracapture.mp3'));
      audioPlayer.play();
          ...
          children: [
            ...
            Positioned(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:
                          _isFrontCamera == false ? Colors.white : Colors.white,
                    ),
                    child: Column(
                      children: [
                        Padding(
